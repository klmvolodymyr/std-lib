...
use VolodymyrKlymniuk\StdLib\Period\Computation;
...
class IntersectTest extends AbstractComputationTest
{
    ...
    public function intersectDataProvider(): array
    {
    ...
    private function getBothInfinityTests(): array
    {
        return [
            [
                'a' => new DateTimeRange(),
    ...
    private function getSingleInfinityTest(bool $swap): array
    {
        $tests = [
            [
